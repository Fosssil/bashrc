...
# remove-junk will remove all the unecessary dependencies
# will save typing work
# just thinking of another user-friendly name ;) 
alias remove-junk="sudo apt autoremove"
